    ...
    >
      ...
      <Card className="p-6 mb-6">
        <div className="flex items-center justify-between mb-5">
          <div>
            ...
            <p className="text-sm text-mist-400 mt-0.5">
              Where every campaign in your account currently sits.
            </p>
          </div>
        </div>
      ...
      <Card className="p-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <Link
            to="/campaigns"
            className="text-sm font-medium text-signal-violet hover:underline flex items-center gap-1"
          >
            View all
            <ArrowRight size={13} />
          </Link>
